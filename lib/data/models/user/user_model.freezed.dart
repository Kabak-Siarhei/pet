...
class _$_UserModel implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(person: $person, support: $support)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, person, const DeepCollectionEquality().hash(support));
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      {@JsonKey(name: 'data') final PersonModel? person,
      @JsonKey(name: 'support') final dynamic support}) = _$_UserModel;
